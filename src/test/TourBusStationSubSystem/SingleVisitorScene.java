...
/**
 * @ClassName SingleVisitorScene
 * @Description 单个游客租凭观光车的场景
 * @Author lc2002
 * @Date 2022/12/10 16:30
 * @Version 1.0
 **/
public class SingleVisitorScene {

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.println("欢迎来到观光车站子系统～");
        System.out.println("在本子系统中，你可以乘坐观光车对整个动物园进行游览");
        System.out.println("动物园正在准备制作观光车...");
        BusCache.loadCache();
        System.out.println(
                """
                动物园准备了三种类型的观光车，如下：
